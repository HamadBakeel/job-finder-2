...
<!-- form-layouts-horizontal.html , Sat, 26 Mar 2022 16:53:13 GMT -->
<head>
    <meta charset="utf-8" />
...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">Job Finder</span>
    </a>
  ...
  <div class="menu-inner-shadow"></div>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text">Admin Dashboard</span></li>
        <li class="menu-item">
